...
const PETALS: Petal[] = [
  ...
  { left: "9%",  size: 14, duration: 18, delay: 4,  sway: 40, o: 0.8,  spin: 6,   tilt: 8,   blur: 0.8, grad: "C", shape: "B" },
  { left: "16%", size: 32, duration: 11, delay: 7,  sway: 78, o: 1,    spin: 3.8, tilt: -14, blur: 0,   grad: "B", shape: "A" },
  { left: "23%", size: 13, duration: 21, delay: 2,  sway: 35, o: 0.72, spin: 7,   tilt: 5,   blur: 0.9, grad: "A", shape: "B" },
  { left: "30%", size: 20, duration: 15, delay: 9,  sway: 55, o: 0.92, spin: 5,   tilt: -6,  blur: 0.3, grad: "C", shape: "A" },
  { left: "37%", size: 16, duration: 17, delay: 5,  sway: 48, o: 0.85, spin: 5.5, tilt: 12,  blur: 0.6, grad: "B", shape: "B" },
  { left: "44%", size: 29, duration: 12, delay: 11, sway: 72, o: 0.95, spin: 4,   tilt: -12, blur: 0,   grad: "A", shape: "A" },
  { left: "50%", size: 12, duration: 22, delay: 1,  sway: 30, o: 0.7,  spin: 7.5, tilt: 6,   blur: 1.0, grad: "C", shape: "B" },
  { left: "57%", size: 22, duration: 14, delay: 8,  sway: 60, o: 0.92, spin: 4.8, tilt: -8,  blur: 0.2, grad: "B", shape: "A" },
  { left: "64%", size: 15, duration: 19, delay: 3,  sway: 42, o: 0.8,  spin: 6.2, tilt: 10,  blur: 0.7, grad: "A", shape: "B" },
  { left: "71%", size: 28, duration: 12, delay: 6,  sway: 70, o: 1,    spin: 4.2, tilt: -11, blur: 0,   grad: "C", shape: "A" },
  { left: "78%", size: 14, duration: 20, delay: 10, sway: 36, o: 0.72, spin: 7,   tilt: 7,   blur: 0.9, grad: "B", shape: "B" },
  { left: "85%", size: 24, duration: 13, delay: 13, sway: 62, o: 0.92, spin: 4.6, tilt: -9,  blur: 0,   grad: "A", shape: "A" },
  { left: "91%", size: 17, duration: 16, delay: 4,  sway: 50, o: 0.84, spin: 5.6, tilt: 9,   blur: 0.5, grad: "C", shape: "B" },
  { left: "96%", size: 13, duration: 21, delay: 8,  sway: 32, o: 0.72, spin: 7.2, tilt: 6,   blur: 0.9, grad: "B", shape: "B" },
  { left: "27%", size: 19, duration: 16, delay: 15, sway: 52, o: 0.88, spin: 5.3, tilt: -7,  blur: 0.4, grad: "B", shape: "A" },
  { left: "60%", size: 18, duration: 15, delay: 17, sway: 54, o: 0.86, spin: 5.1, tilt: 11,  blur: 0.45,grad: "A", shape: "A" },
  { left: "82%", size: 14, duration: 19, delay: 12, sway: 38, o: 0.74, spin: 6.8, tilt: -5,  blur: 0.8, grad: "C", shape: "B" },
];
